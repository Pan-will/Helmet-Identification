...
class mtcnn():
    def __init__(self):
        self.Pnet = create_Pnet('model_data/model_data_face/pnet.h5')
        self.Rnet = create_Rnet('model_data/model_data_face/rnet.h5')
        self.Onet = create_Onet('model_data/model_data_face/onet.h5')
